...
ANSIBLE_HOSTVARS_INTERFACE_OVS_SYSTEM = "ansible_ovs_system"
ANSIBLE_HOSTVARS_INTERFACES_CONTENT = ["lo", "eth0", "eth1", "eth2", "ovs-system"]
TEST_HOSTVARS_REDUCED = {
    INSTANCE_1_NAME: {
        ...
        ANSIBLE_HOSTVARS_INTERFACE_OVS_SYSTEM: INSTANCE_1_OVS_SYSTEM_IFACE_DATA,
    },
}
TEST_HOSTVARS = {
    **TEST_HOSTVARS_REDUCED,
    INSTANCE_2_NAME: {
        ...
        ANSIBLE_HOSTVARS_INTERFACE_OVS_SYSTEM: INSTANCE_2_OVS_SYSTEM_IFACE_DATA,
    },
    INSTANCE_3_NAME: {
        ...
        ANSIBLE_HOSTVARS_INTERFACE_OVS_SYSTEM: INSTANCE_3_OVS_SYSTEM_IFACE_DATA,
    },
}
