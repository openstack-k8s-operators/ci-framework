...
TEST_HOSTVARS = {
    INSTANCE_1_NAME: {ANSIBLE_HOSTVARS_HOSTNAME: INSTANCE_1_NAME + "-hostname"},
    INSTANCE_2_NAME: {ANSIBLE_HOSTVARS_HOSTNAME: INSTANCE_2_NAME + "-hostname"},
    INSTANCE_3_NAME: {ANSIBLE_HOSTVARS_HOSTNAME: INSTANCE_3_NAME + "-hostname"},
}
