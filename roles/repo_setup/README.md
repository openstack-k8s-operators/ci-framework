...
* `cifmw_repo_setup_src`: (String) repo-setup repository location. Takes its value from cifmw_repo_setup_url at group_vars/all.yaml, defaults to `https://github.com/openstack-k8s-operators/repo-setup`.
