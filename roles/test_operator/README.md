...
* `cifmw_test_operator_artifacts_basedir`: Default value: See defaults in [main.yml](defaults/main.yml)
...
* `cifmw_test_operator_log_pod_definition`: Default value: See defaults in [main.yml](defaults/main.yml)
...
cifmw_test_operator_stages:
  - name: tempest
    type: tempest
```
* `cifmw_test_operator_storage_class`: Default value: See defaults in [main.yml](defaults/main.yml)
* `cifmw_test_operator_storage_class_prefix`: Default value: See defaults in [main.yml](defaults/main.yml)
...
* `cifmw_test_operator_tempest_config`: Default value: See defaults in [main.yml](defaults/main.yml)
...
* `cifmw_test_operator_tempest_image`: Default value: See defaults in [main.yml](defaults/main.yml)
* `cifmw_test_operator_tempest_image_tag`: Default value: See defaults in [main.yml](defaults/main.yml)
...
* `cifmw_test_operator_tempest_namespace`: Default value: See defaults in [main.yml](defaults/main.yml)
...
* `cifmw_test_operator_tempest_registry`: Default value: See defaults in [main.yml](defaults/main.yml)
...
* `cifmw_test_operator_tobiko_config`: Default value: See defaults in [main.yml](defaults/main.yml)
...
* `cifmw_test_operator_tobiko_image`: Default value: See defaults in [main.yml](defaults/main.yml)
* `cifmw_test_operator_tobiko_image_tag`: Default value: See defaults in [main.yml](defaults/main.yml)
...
* `cifmw_test_operator_tobiko_namespace`: Default value: See defaults in [main.yml](defaults/main.yml)
...
* `cifmw_test_operator_tobiko_registry`: Default value: See defaults in [main.yml](defaults/main.yml)
...
* `cifmw_test_operator_tobiko_ssh_keysize`: Default value: See defaults in [main.yml](defaults/main.yml)
* `cifmw_test_operator_tobiko_ssh_keytype`: Default value: See defaults in [main.yml](defaults/main.yml)
...
* `cifmw_test_operator_ansibletest_config`: Default value: See defaults in [main.yml](defaults/main.yml)
...
* `cifmw_test_operator_ansibletest_image`: Default value: See defaults in [main.yml](defaults/main.yml)
* `cifmw_test_operator_ansibletest_image_tag`: Default value: See defaults in [main.yml](defaults/main.yml)
...
* `cifmw_test_operator_ansibletest_namespace`: Default value: See defaults in [main.yml](defaults/main.yml)
...
* `cifmw_test_operator_ansibletest_registry`: Default value: See defaults in [main.yml](defaults/main.yml)
...
* `cifmw_test_operator_horizontest_config`: Default value: See defaults in [main.yml](defaults/main.yml)
...
* `cifmw_test_operator_horizontest_image`: Default value: See defaults in [main.yml](defaults/main.yml)
* `cifmw_test_operator_horizontest_image_tag`: Default value: See defaults in [main.yml](defaults/main.yml)
...
* `cifmw_test_operator_horizontest_namespace`: Default value: See defaults in [main.yml](defaults/main.yml)
...
* `cifmw_test_operator_horizontest_registry`: Default value: See defaults in [main.yml](defaults/main.yml)
