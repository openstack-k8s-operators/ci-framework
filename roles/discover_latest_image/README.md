...
`cifmw_discovered_images_dict` is reset, erasing any discovered image data that
may exist in that dict. This is to avoid collisions or mismatches between calls
of this role. Either call the role once with all of the image requests you
intend to make, or be careful to manage the complete collection of discovered
images yourself.
