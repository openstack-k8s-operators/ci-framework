...
* `devscripts_layout`: Run the [devscripts](../roles/devscripts.md) parts of the [reproducer](../reproducers/04-validated-architecture.md) when dev-scripts is activated.
* `libvirt_layout`: Run the [libvirt_manager](../roles/libvirt_manager.md) part of the [reproducer](../reproducers/04-validated-architecture.md) when libvirt is activated.
